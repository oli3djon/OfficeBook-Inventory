...
return [
    ...
    */
    'attributes'           => [
        'name'               => "'Имя'",
        'surname'               => "'Полное имя'",
        'telwork'               => "'Рабочий телефон'",
        'telpersonal'               => "'Личный телефон'",
        'mailwork'               => "'E-mail рабочий'",
        'mailpersonal'               => "'E-mail личный'",
        'skype'               => "'Skype'",
        'text'               => "'Дополнительная информация'",
        'number'               => "'Инвентарный номер'",
        'peoples'               => "'Ответственный сотрудник'",
        'points'               => "'Место нахождения'",
